; SndVolWeb Installer with .NET 8 Runtime Auto-Download
; Author: Hadi Cahyadi <cumulus13@gmail.com>

!define APP_NAME "SndVolWeb"
!define APP_VERSION "1.0.1"
!define APP_PUBLISHER "Hadi Cahyadi"
!define APP_URL "https://github.com/cumulus13/SndVolWeb"
...
!define MUI_FINISHPAGE_RUN "$INSTDIR\SndVolWeb.exe"
...
Section "Install" SecInstall
  ...
  CreateShortcut "$SMPROGRAMS\${APP_PUBLISHER}\${APP_NAME}.lnk" "$INSTDIR\SndVolWeb.exe"
  CreateShortcut "$DESKTOP\${APP_NAME}.lnk" "$INSTDIR\SndVolWeb.exe"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APP_NAME}" "DisplayIcon" "$INSTDIR\SndVolWeb.exe"
...
Section "Uninstall"
  ...
  nsExec::Exec 'taskkill /F /IM SndVolWeb.exe'
  Sleep 500
  
  ; Remove files
  Delete "$INSTDIR\SndVolWeb.exe"
  Delete "$INSTDIR\*.dll"
  Delete "$INSTDIR\*.json"
